...
class DataGenerator:
    def __init__(self, anomaly_rate: float = 0.03, seed: int | None = None):
        """
    ...
    def generate_normal_reading(self, sensor: Dict, timestamp: datetime,
                              prev_reading: Dict | None = None) -> Dict[str, Any]:
    ...
    def generate_dataset(self, num_observations: int,
        ...
        prev_readings: dict[Any, dict[str, Any] | None] = {sensor['sensor_id']: None for sensor in sensors}
